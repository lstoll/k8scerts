...
require (
	...
	k8s.io/api v0.32.1
	k8s.io/apimachinery v0.36.0-alpha.1.0.20260220060104-eae5e9edd982
...
replace (
	k8s.io/api => k8s.io/api v0.0.0-20260224060517-28495fa55aa9
	k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver v0.0.0-20260220184839-a69b5c14b56d
	k8s.io/apimachinery => k8s.io/apimachinery v0.36.0-alpha.1.0.20260220060104-eae5e9edd982
	k8s.io/client-go => k8s.io/client-go v0.0.0-20260223181018-62f2159da236
)
